...
export default function InsuranceApplication() {
  ...
  const storeDocumentInBlockchain = async (encryptedLink, encryptedKey) => {
    ...
    try {
      await contract.methods.storeDocument(dummyRecipientAddress, encryptedLink, encryptedKey)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      for (const document of documents) {
        ...
        const encryptedLink = encryptData(ipfsLink);
        const encryptedKey = encryptData('some-encryption-key');
